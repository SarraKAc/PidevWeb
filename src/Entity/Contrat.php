 ...
 * Contrat
 *
 * @ORM\Table(name="contrat", indexes={@ORM\Index(name="id_receiver", columns={"id_receiver"}), @ORM\Index(name="id_m", columns={"id_m"}), @ORM\Index(name="id_sender", columns={"id_sender"})})
 * @ORM\Entity
 */
class Contrat
{
