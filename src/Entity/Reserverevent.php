 ...
 * Reserverevent
 *
 * @ORM\Table(name="reserverevent", indexes={@ORM\Index(name="id", columns={"id_user"}), @ORM\Index(name="id_user_2", columns={"id_user"}), @ORM\Index(name="id_evenement", columns={"id_evenement"}), @ORM\Index(name="id_user", columns={"id_user"})})
 * @ORM\Entity
 */
class Reserverevent
{
